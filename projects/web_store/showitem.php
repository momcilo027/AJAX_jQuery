...
$mysqli = mysqli_connect("localhost", "root", "", "web_store");
...
$get_item_sql .= "FROM store_items AS si LEFT JOIN store_categories AS c on c.id = si.cat_id WHERE si.id = '".$safe_item_id."'";
